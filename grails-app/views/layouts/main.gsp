...
<div id="login" role="complementary" align="left">
    <g:if test="${session.landlord}">
      ...
      <g:form controller="landlord" action="logout" method="post" style ="font-family: comic sans ms">
        <span>
    ...
    <g:else> 
       <p style ="font-family: comic sans ms;"><br>Have An Account? Login here!<br></p>
      <g:if test="${flash.message}">
        <div class="message">${flash.message}</div>
      </g:if>
      <g:form controller="landlord" action="authenticate" method="post" style ="font-family: comic sans ms; font-size: .9em;">
        <br>
       ...
       <p style ="font-family: comic sans ms; font-style: bold;"><br>New to HappyLandlord? Register here!<br></p>
...
<div class="footer" role="contentinfo" style =" background-color: #007ca2; color: #99FFCC">
  <p style="text-align: center;">
    <a href="/HappyL/contactForm"
      style ="font-size: 1.1em; font-style: bold; font-family: tahoma">Contact Us
    </a>
